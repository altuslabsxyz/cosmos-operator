...
//+kubebuilder:rbac:groups=cosmos.altuslabs.xyz,resources=statefuljobs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cosmos.altuslabs.xyz,resources=statefuljobs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cosmos.altuslabs.xyz,resources=statefuljobs/finalizers,verbs=update
