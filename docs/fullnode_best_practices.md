...
The above is a workaround; there is [future work](https://github.com/altuslabsxyz/cosmos-operator/issues/37) planned to allow the Operator to handle this scenario for you.
...
There is [future work](https://github.com/altuslabsxyz/cosmos-operator/issues/38) planned for the Operator to handle this scenario for you.
